        ...
        fun bind(model: DataX) {
            binding.apply {
                ...
                if(model.status == "resolved") {
                    ...
                    ivOpenClose.text = binding.root.resources.getString(R.string.conversation_marked_Close_admin)+" "+model.reply_date.changeDateFormat("yyyy-MM-dd HH:mm:ss", "dd MMM, yyyy HH:mm a")
                } else if(model.status == "re-open") {
                    group.visibility = View.GONE
                    ivOpenClose.visibility = View.VISIBLE
                    ivDate.visibility = View.GONE
                    ivOpenClose.text = binding.root.resources.getString(R.string.conversation_marked_reOpen_admin)+" "+model.reply_date.changeDateFormat("yyyy-MM-dd HH:mm:ss", "dd MMM, yyyy HH:mm a")
